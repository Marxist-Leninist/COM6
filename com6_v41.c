/*
 * COM6 v41 - Deep KC for 8192 + v40 Core
 * ========================================
 * v40's C-prefetch and single parallel region are kept. New:
 *
 * 4th blocking tier for n>4096 (8192):
 *   MC=64, KC=512, NC=1024
 *   - A panel: 64*512*8 = 256KB (exactly fills L2)
 *   - A micro: 6*512*8 = 24KB (fits L1)
 *   - B panel: 1024*512*8 = 4MB (half L3)
 *   - pc iterations: 8192/512 = 16 (vs 26 with KC=320) — 38% fewer!
 *   - ic blocks: 8192/64 = 128 (more parallelism for 8 threads)
 *
 * Fewer pc iterations = fewer B-repacks, fewer barriers, less overhead.
 *
 * Compile:
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v41 - Single Parallel Region + C-Prefetch (%d threads)\n",nth);
    ...
    printf("\nv41: Deep KC=512 for 8192 + v40 core\n");
    return 0;
}
