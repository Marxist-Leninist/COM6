/*
 * COM6 v72 - v24 Kernel + Adaptive Blocking + 8192 Support
 * =========================================================
 * v24 proven micro-kernel (branch-free, 49.1 GF peak) + improvements:
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v72 - v24 Kernel + Adaptive Blocking (%d threads)\n",nth);
