/*
 * COM6 v57 - Streaming B-Pack + Dynamic Schedule
 * ===============================================
 * Based on v26 (proven best). Two targeted improvements:
 * 1. Non-temporal (streaming) stores for B-packing: bypasses L1/L2,
 *    writes B panel directly to L3/RAM. Keeps L1/L2 clean for A+C.
 * 2. Dynamic scheduling for n>=2048 (better load balance).
 * 3. 8192 benchmark, skip 1T for n>=4096, cooldown between sizes.
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -o com6_v31 com6_v31.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v57 - Streaming B-Pack + Dynamic Schedule (%d threads)\n",nth);
