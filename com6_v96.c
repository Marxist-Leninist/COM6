/*
 * COM6 v96 - Best-of-Both Dispatch
 * =====================================================
 * Optimized dispatch based on v95/v96 empirical testing:
 * - n>=8192: Strassen (shorter bursts sustain higher clocks on 15W TDP)
 * - n>=4096: IC-parallel (shared B in L3: 5MB < 8MB, +12% vs JC-par)
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v96 - Best-of-Both Dispatch (%d threads)\n",nth);
    ...
    printf("Run individual: ./com6_v96 <size> [mt|1t]\n");
    return 0;
}
