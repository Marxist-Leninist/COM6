"""COM6 v61 vs OpenBLAS — Fair interleaved comparison
...
def bench_com6_single(exe, n, mode="mt"):
    ...
    for line in r.stdout.split('\n'):
        line = line.strip()
        if 'GF' in line:
            # Parse "MT  2048x2048  |   340.3 ms |   50.5 GF (8 threads)"
            parts = line.split('|')
            for p in parts:
                if 'GF' in p:
...
if __name__ == "__main__":
    ...
    exe = "C:/Users/Scott/com6_v61.exe"

    print("=" * 80)
    print("  COM6 v61 vs OpenBLAS (numpy) — Fair Interleaved Comparison")
