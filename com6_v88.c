/*
 * COM6 v88 - L1-Safe KC + Physical-Core Threading
 * ================================================
 * BUG FIX: v88's KC=768 for 8192 made A-panel per micro-kernel
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v88 com6_v88.c -lm
 */
...
/* Thread scaling: 8T for n<=4096 (short enough to avoid throttle), 4T for n>=8192 */
static int get_mt_threads(int n, int max_threads){
    if(n >= 8192 && max_threads > 4) return 4;
    return max_threads;
}
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v88 - L1-Safe KC + Physical-Core Threading (%d threads)\n",nth);
    ...
    printf("\nv88: Retuned L3 blocking + prefetch A-packing.\n");
    printf("Run individual: ./com6_v88 <size> [mt|1t]\n");
    return 0;
}
