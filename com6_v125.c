/*
 * COM6 v125 - JC-Parallel All Sizes on Server
 * =============================================
 * v124 core + JC-parallel for ALL sizes on large-L2 servers.
 *
 * v124 used IC-parallel for n<2048 on monolithic servers. Testing
 * showed JC-parallel wins at 1024 (+12%) and 512 (+35%) on Xeon 16C
 * because JC has zero barriers and each thread works independently.
 * With 16 threads, the barrier overhead of IC-parallel dominates at
 * small sizes even when L3 sharing helps B-panel reuse.
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp \
 *       -o com6_v125 com6_v125.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("COM6 v125 - JC-Parallel All Sizes on Server\n");
    ...
    printf("\nv125: JC-par all sizes on server. Strassen depth=%d, KC=%d.\n",
    ...
    printf("Run individual: ./com6_v125 <size> [mt|1t]\n");
