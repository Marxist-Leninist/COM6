/*
 * COM6 v94 - JC-Parallel for Large + Adaptive NC
 * ================================================
 * Builds on v94 (beta-0/1, C-prefetch, 2x B-pack, dynamic scheduling).
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v94 com6_v94.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v94 - JC-Parallel + Adaptive NC (%d threads)\n",nth);
    ...
    printf("\nv94: v92 + JC-parallel for n>=4096 + NC=1024 for large\n");
    printf("Run individual: ./com6_v94 <size> [mt|1t]\n");
    return 0;
}
