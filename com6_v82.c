/*
 * COM6 v82 - Universal Persistent Thread Pool
 * ============================================
...
#define KC_HUGE  768
#define MC_HUGE  36     /* 36*768*8=221KB (fits L2; 6 MR-panels vs 5) */
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v82 - Universal Persistent Thread Pool (%d threads)\n",nth);
