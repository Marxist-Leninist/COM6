/*
 * COM6 v45 - 4x k-Unrolled pack_A
 * ==================================
 * 4x k-unrolled pack_A for better ILP in packing phase.
 * 24 independent loads + stores per loop body (4 k-values x 6 rows).
 * Gives CPU more scheduling freedom to overlap loads from different rows.
 *
 * Compile:
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v45 - 4x Pack_A Unroll (%d threads)\n",nth);
    ...
    printf("\nv45: 4x unrolled pack_A for better ILP\n");
    return 0;
}
