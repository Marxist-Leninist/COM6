"""COM6 v127 vs OpenBLAS -- Fair interleaved comparison"""
...
if __name__ == "__main__":
    ...
    exe = "C:/Users/Scott/com6-matmul/com6_v127.exe"
    cool = 15
    print("=" * 80)
    print("  COM6 v127 vs OpenBLAS (numpy) -- Fair Interleaved Comparison")
