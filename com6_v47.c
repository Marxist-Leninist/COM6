/*
 * COM6 v47 - No-Pack Small Matrix + v47 Core
 * =============================================
 * v47 loses at 256 (38 GF vs BLAS 101 GF) because packing overhead dominates
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -o com6_v47 com6_v47.c -lm
 */
 ...
 * Uses ikj loop with AVX2 FMA on unpacked data.
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v47 - 4x Pack_A Unroll (%d threads)\n",nth);
    ...
    printf("\nv47: 4x unrolled pack_A for better ILP\n");
    return 0;
}
