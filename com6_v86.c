/*
 * COM6 v86 - L1-Safe KC + Physical-Core Threading
 * ================================================
 * BUG FIX: v86's KC=768 for 8192 made A-panel per micro-kernel
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v86 com6_v86.c -lm
 */
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v86 - L1-Safe KC + Physical-Core Threading (%d threads)\n",nth);
    ...
    printf("\nv86: Retuned L3 blocking + prefetch A-packing.\n");
    printf("Run individual: ./com6_v86 <size> [mt|1t]\n");
    return 0;
}
