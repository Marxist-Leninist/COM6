"""COM6 v99 vs OpenBLAS — Fair interleaved comparison
...
if __name__ == "__main__":
    ...
    exe = "C:/Users/Scott/com6-matmul/com6_v99.exe"

    print("=" * 80)
    print("  COM6 v99 vs OpenBLAS (numpy) -- Fair Interleaved Comparison")
