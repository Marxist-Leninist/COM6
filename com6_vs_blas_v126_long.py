"""COM6 v126 vs OpenBLAS -- Long-cooldown comparison for thermal stability"""
import numpy as np, time, subprocess, os, sys

COOLDOWN = 15

def bench_openblas(n, threads):
    script = f'''
...
if __name__ == "__main__":
    ...
    exe = "C:/Users/Scott/com6-matmul/com6_v126.exe"
    print("=" * 80)
    print("  COM6 v126 vs OpenBLAS -- Long Cooldown (15s between tests)")
    print("=" * 80)
    print()
    ...
    for n in sizes:
        ...
        time.sleep(COOLDOWN)
        blas_gf = bench_openblas(n, 8)
        time.sleep(COOLDOWN)
        com6_gf = bench_com6(exe, n)
    ...
    print(f"\nCOM6 wins {wins}/{len(sizes)} sizes")
