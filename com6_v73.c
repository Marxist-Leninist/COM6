/*
 * COM6 v73 - v72 + MT-Specific Blocking
 * =======================================
 * v72 base + separate MT blocking for better thread parallelism:
 *   1. Adaptive blocking: MC=120/KC=256 for n<=1024, MC=96/KC=320 for n<=4096,
 *      MC=72/KC=384/NC=1536 for n>=8192 (B-panel fits 8MB L3)
 *   2. 4x k-unrolled A-packing (from v62)
 *   3. Single parallel region for n>=4096 (eliminates fork/join overhead)
 *   4. CLI mode for cold individual-size testing
 *   5. 4-second cooldown between sizes in full benchmark
 *   6. 8192 benchmark included
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v72 com6_v72.c -lm
 */
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v73 - v24 Kernel + MT-Specific Blocking (%d threads)\n",nth);
    ...
    printf("\nv24 proven kernel + adaptive blocking + 8192 support.\n");
    printf("Run individual: ./com6_v72 <size> [mt|1t]\n");
    return 0;
}
