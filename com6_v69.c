/*
 * COM6 v69 - Adaptive NT Store Threshold
 * =======================================
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -o com6_v69 com6_v69.c -lm
 */
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v69 - Adaptive NC + v67 Core (%d threads)\n",nth);
    ...
    printf("Run individual sizes: ./com6_v69 <size> [mt|1t]\n");
    return 0;
}
