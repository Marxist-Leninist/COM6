/*
 * COM6 v132 - v130 + Non-Temporal Stores for Large Matrices
 * ==========================================================
 * v130 core (persistent pool + OpenMP IC) with NT store optimization:
 *
...
int main(int argc, char**argv){
    ...
    printf("COM6 v132 - Persistent Pool + NT Stores for Large Matrices\n");
    ...
    printf("\nv132: v130 + non-temporal stores (vmovntpd) for n>=4096.\n");
    ...
    printf("Run individual: ./com6_v132 <size> [mt|1t]\n");
