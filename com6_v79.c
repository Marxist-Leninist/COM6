/*
 * COM6 v79 - Deep KC for Fewer C-Passes
 * =======================================
 * v77 base. Changes for huge tier (n>4096):
 *   1. KC_HUGE=768: 8192/768=11 C-passes (was 16 with KC=512, 31% fewer)
 *      → dramatically reduces DRAM traffic on C matrix at 8192
 *   2. MC_HUGE=30: 30*768*8=184KB (fits 256KB L2 with 72KB headroom)
 *   3. NC_HUGE=1024: B-panel=1024*768*8=6.3MB (fits 8MB L3 with room for A)
 *   4. 8192/30=274 ic-blocks for 8 threads → 34/thread, good balance
 *
 * i7-10510U: L1=64KB, L2=256KB, L3=8MB shared, 4C/8T, 15W TDP
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v79 com6_v79.c -lm
 */
...
#define KC_HUGE  768
#define MC_HUGE  30     /* 30*768*8=184KB (fits L2 with headroom) */
#define NC_HUGE  1024   /* 1024*768*8=6.3MB (fits 8MB L3) */
...
int main(int argc, char**argv){
    ...
    /* Full benchmark */
    printf("====================================================================\n");
    printf("  COM6 v79 - Deep KC for Fewer C-Passes (%d threads)\n",nth);
    ...
    printf("\nv79: Deep KC=768 for 31%% fewer C-passes at 8192.\n");
    printf("Run individual: ./com6_v79 <size> [mt|1t]\n");
    return 0;
}
