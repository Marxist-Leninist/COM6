/*
 * COM6 v58 - Adaptive NC for L3 Headroom + Streaming B-Pack
 * =========================================================
 * v57 + adaptive NC: NC=2048 for n<=4096, NC=1536 for n>4096.
 *
 * L3 budget at n=8192 (8MB shared):
 *   NC=2048: B=5.12MB + 8*240KB A = 7.04MB (88% L3 — thrashing)
 *   NC=1536: B=3.84MB + 8*240KB A = 5.76MB (72% L3 — headroom)
 *
 * Fewer jc iterations vs NC=1024 (8192/1536=5.3 vs 8192/1024=8),
 * meaning less B-repacking overhead. Sweet spot between L3 fit and
 * packing amortization.
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -o com6_v58 com6_v58.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v58 - Streaming B-Pack + Dynamic Schedule (%d threads)\n",nth);
