/*
 * COM6 v123 - Platform-Adaptive Strassen + L2-Tuned KC
 * =====================================================
 * v122 base + two key improvements:
 *
 * 1) Adaptive Strassen depth:
 *    - Monolithic/thermal-limited: depth=1 (same as v122, proven)
 *    - Chiplet/server (EPYC): depth=2 (23.4% fewer FLOPs vs 12.5%)
 *    - Override: COM6_STRASSEN_DEPTH=N
 *    2-level Strassen means 49 × BLIS(2048) at 8192 — great for
 *    server CPUs but kills thermally-limited laptops.
 *
 * 2) Auto-tuned KC for larger L2 caches:
 *    - Laptop (256KB L2): KC=256/320 (unchanged, hand-tuned)
 *    - EPYC (512KB L2):  KC=480 (1.5× more FMA per pack)
 *    - Computes KC to fill ~85% of L2 while keeping MC >= 48
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp \
 *       -o com6_v123 com6_v123.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("COM6 v123 - Adaptive Strassen + L2-Tuned KC\n");
    ...
    printf("\nv123: Adaptive Strassen (depth=%d) + L2-tuned KC=%d. v122 BLIS core.\n",
    ...
    printf("Run individual: ./com6_v123 <size> [mt|1t]\n");
