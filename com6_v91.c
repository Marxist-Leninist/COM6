/*
 * COM6 v91 - v26 Architecture + Beta-0/1 Kernels
 * ================================================
 * v26's exact MT algorithm (fork-join per panel, omp for scheduling)
 * with two targeted improvements:
 * 1. Beta-0 micro-kernel: skip C load for first KC panel
 *    (eliminates memset + 12 unnecessary loads per 6x8 tile)
 * 2. C-prefetch at beta-1 kernel entry (hide DRAM latency)
 * 3. CLI mode: ./com6_v91 <size> [mt|1t] for cold-CPU testing
 * 4. Thermal cooldown between sizes in full benchmark
 * 5. 8192 support (same blocking as 2048/4096)
 *
 ...
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v91 com6_v91.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v91 - Beta-0/1 Kernels + MT Tuning (%d threads)\n",nth);
    ...
    printf("  Beta-0/1 kernels, C-prefetch, parallel B-pack\n");
    printf("  4s cooldown between sizes for thermal fairness\n");
    printf("====================================================================\n\n");
    ...
    printf("\nv91: v26 arch + persistent threads + beta-0/1 kernels\n");
    printf("Run individual: ./com6_v91 <size> [mt|1t]\n");
    return 0;
}
