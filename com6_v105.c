/*
 * COM6 v105 - v103 persistent buffers + v102 thermal pacing
 * ====================================================
 * Observed at 8192 MT:
 *   v99    baseline:      39.6 GF
 *   v102   pace=500:      59.6-65.0 GF (+50% to +64% vs v99)
 *   v103   persistent bufs: 48.3-64.5 GF
 *
 * Both helped ~equally. v105 combines them: persistent packing buffers
 * (v103) across the 7 Strassen sub-muls, AND thermal pacing (v102) sleep
 * between sub-muls to keep the 15W CPU in turbo.
 *
 * Pace duration via COM6_STRASSEN_PACE_MS env var, default 500ms.
 * Set to 0 to disable pacing (behaves identically to v103).
 *
 * Compile:
 *   gcc -O3 -march=native -mavx2 -mfma -funroll-loops -fopenmp -static -o com6_v105 com6_v105.c -lm
 */
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v105 - Persistent packing buffers + Thermal pacing (%d threads)\n",nth);
    ...
    printf("Run individual: COM6_STRASSEN_PACE_MS=N ./com6_v105 <size> [mt|1t]\n");
    return 0;
}
