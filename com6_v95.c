/*
 * COM6 v95 - Strassen-Hybrid for 8192 + v94 JC-Parallel
 * =====================================================
 * Adds single-level Strassen for n>=8192:
 * - Split into 4096 subblocks, 7 multiplications instead of 8
                           ...
                           double*__restrict__ C,int n)
{
    ...
    /* Single-level Strassen for huge matrices (n must be even) */
    if(n >= 8192 && (n & 1) == 0){
...
int main(int argc, char**argv){
    ...
    printf("====================================================================\n");
    printf("  COM6 v95 - Strassen-Hybrid + JC-Parallel (%d threads)\n",nth);
    printf("  n>=8192: Strassen (7 sub-muls of n/2) | n>=2048: JC-par | n<2048: IC-par\n");
    ...
    printf("\nv95: Strassen for n>=8192 (7 sub-muls of n/2) + v94 JC-parallel\n");
    printf("Saves 12.5%% FLOPs at 8192, each sub-mul uses full BLIS GEMM\n");
    printf("Run individual: ./com6_v95 <size> [mt|1t]\n");
    return 0;
}
